...
\DeclareCaptionFormat{myformat}{\fontsize{10pt}{20pt}\selectfont#1#2#3}
...
\input{Chapter 1/1. Chapter1}

\clearpage

%----------------------------------------------------------------------

\input{Chapter 2/1. Chapter2}

\clearpage

%----------------------------------------------------------------------

\input{Chapter 3/1. Chapter3}

\clearpage

%----------------------------------------------------------------------

\input{Chapter 4/1. Chapter4}
